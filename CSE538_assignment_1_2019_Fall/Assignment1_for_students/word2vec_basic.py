...
def generate_training_pairs(context_word, window):
    window_copy = window[:]
    window_copy.remove(context_word)

    training_pairs = []
    for w in window_copy:
        predicted_word = w
        tup = (context_word, predicted_word)
        training_pairs.append(tup)
...
if __name__ == '__main__':
  ...
  batch_size = 64 # VARIED
  embedding_size = 64  # Dimension of the embedding vector.
  # skip_window = 14      # How many words to consider left and right.
  skip_window = 4
  # Varying skip window causes decrease for NCE
  ...
  # Not much of an effect for varying this
