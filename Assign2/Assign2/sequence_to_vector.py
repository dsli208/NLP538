...
class DanSequenceToVector(SequenceToVector):
    ...
    def call(self,
        ...
        if training:
            ...
            uni_mask = tf.random.uniform(tf.shape(vector_sequence), 0, 1, float64, self.dropout)
        ...
        # Get average
        h = tf.reduce_mean(vector_sequence, axis=1) # avg
...
class GruSequenceToVector(SequenceToVector):
    ...
    def __init__(self, input_dim: int, num_layers: int):
        ...
        self.gru = tf.keras.layers.GRU(input_dim, activation='tanh')
        # TODO(students): start
        # ...
        # TODO(students): end
